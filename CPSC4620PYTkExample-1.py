# This is a sample Python and TKinter script for a patient info system that has one table
# Connects to MySQL for data updates, inserts, and display.
...
#all menthods needed to deal with your database
class Database:
    def __init__(self):
        try: self.dbConnection = mysql.connector.connect(host="xxxxx.rds.amazonaws.com",
                                               user="username",
                                               passwd="password", database="yourschema")
